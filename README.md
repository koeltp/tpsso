...
cd TPSSO/TPSSO.Api
# 数据迁移：添加初始迁移
dotnet ef migrations add InitialCreate --project TPSSO.Infrastructure --startup-project TPSSO.Api --output-dir Data/Migrations
# 数据迁移：更新数据库
dotnet ef database update --project TPSSO.Infrastructure --startup-project TPSSO.Api
